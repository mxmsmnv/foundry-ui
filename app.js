...
const tokenData = [
  ['Primary teal','#2A8288','--fd-accent'],['Accent hover','#236F74','--fd-accent-hover'],['Accent contrast','#FFFFFF','--fd-accent-contrast'],['Off black','#2B2D33','--fd-color-text'],['Link teal','#2A8288','--fd-color-link'],['Link hover','#236F74','--fd-color-link-hover'],['Warm grey','#F1EDE6','--fd-color-surface-strong'],['Warm subtle','#F8F6F2','--fd-color-surface'],['Blue subtle','#DDF4FB','--fd-color-info'],['Danger','#B70017','--fd-color-danger']
];
